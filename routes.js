...
router.get("/configuration/getdevicelist", configuration.getDeviceList);
router.post("/configuration/amazonlogin", configuration.login);
router.post("/configuration/:id/addsetting", configuration.addSetting);
